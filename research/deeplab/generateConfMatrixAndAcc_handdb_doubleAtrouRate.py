...
pb_path = "/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsaraharm_4000/exp/" + modelFolder + "/export/frozen_inference_graph" + modelName + "_doubleAtrou.pb"
if runAcc:
  logFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsaraharm_4000/exp/" + modelFolder + '_' + baseName + modelName + '_doubleAtrou_acc.log', 'a+')
confMatrixLogFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsaraharm_4000/exp/" + modelFolder + '_' + baseName + modelName + '_doubleAtrou_confMatrix.log', 'a+')
