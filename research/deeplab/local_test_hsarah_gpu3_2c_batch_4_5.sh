...
# Set up the working directorie
HSARAH_FOLDER="hsarah"
EXP_FOLDER="exp/train_on_trainval_set_30000_batchnorm_correctlabel_eval_test_train_2classes_5"
...
# Run evaluation. This performs eval over the full val split (1449 images) an
# will take a while.
