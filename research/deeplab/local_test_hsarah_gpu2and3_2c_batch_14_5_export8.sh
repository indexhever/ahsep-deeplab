...
# Go to datasets folder and download HSARAH VOC 2012 segmentation datase
DATASET_DIR="datasets"
#cd "${WORK_DIR}/${DATASET_DIR}"
#sh download_and_convert_hsarah.sh
...
EXP_FOLDER="exp/train_on_trainval_set_30000_batchnorm_correctlabel_eval_test_train_2classes_batch_14_5"
...
EXPORT_PATH="${EXPORT_DIR}/frozen_inference_graph_${EXPORT_OUTPU_STRIDE}.pb"
