...
EXP_FOLDER="exp/train_on_trainval_set_30000_batchnorm_correctlabel_eval_test_train_2classes_batch_14_sem_mirrors_4"
...
# Run evaluation. This performs eval over the full val split (1449 images) a
# will take a while.
