...
if runAcc:
  logFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsarah/exp/" + modelFolder + '_' + baseName + '_gtea_acc.log', 'a+')
confMatrixLogFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsarah/exp/" + modelFolder + '_' + baseName + '_gtea_confMatrix.log', 'a+')
deepModel = DeepLabModel(pb_path)

if isDebug:
  val = np.array(['s1_cheese_0000000020'])
else:
...
for idx in val:
  ...
  print "seg_map.shape: " + str(seg_map.shape)
  print "image.size: " + str(imagem.size)
  print "label.size: " + str(label.size)
  print "labelArray.shape: " + str(labelArray.shape)
