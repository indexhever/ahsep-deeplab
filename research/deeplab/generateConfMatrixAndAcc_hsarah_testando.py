...
if runAcc:
  logFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsarah/exp/" + modelFolder + '_' + baseName + 'testando_acc.log', 'a+')
confMatrixLogFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsarah/exp/" + modelFolder + '_' + baseName + 'testando_confMatrix.log', 'a+')
deepModel = DeepLabModel(pb_path)

if isDebug:
  val = np.array(['7_image0025'])
else:
