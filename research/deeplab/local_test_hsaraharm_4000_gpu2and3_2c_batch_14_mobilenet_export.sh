...
EXP_FOLDER="exp/train_on_trainval_set_30000_batchnorm_correctlabel_eval_test_train_2classes_14batch_mobilenet"
...
# Export the trained checkpoi
CKPT_PATH="${TRAIN_LOGDIR}/model.ckpt-${NUM_ITERATIONS}"
#EXPORT_PATH="${EXPORT_DIR}/frozen_inference_graph.pb"
EXPORT_PATH="${EXPORT_DIR}/frozen_inference_graph.bytes"
