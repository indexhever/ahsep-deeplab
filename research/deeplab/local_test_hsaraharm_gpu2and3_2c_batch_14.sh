...
sh download_and_convert_hsaraharm.sh

# Go back to original directory.
cd "${CURRENT_DIR}"

# Set up the working directorie
HSARAH_FOLDER="hsaraharm"
EXP_FOLDER="exp/train_on_trainval_set_30000_batchnorm_correctlabel_eval_test_train_2classes_batch_14"
