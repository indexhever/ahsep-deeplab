...
hsaraharm = "_hsaraharm_4000"
pb_path = "/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsaraharm_4000/exp/" + modelFolder + "/export/frozen_inference_graph.pb"
if runAcc:
  logFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsaraharm_4000/exp/" + modelFolder + '_' + baseName + '_acc.log', 'a+')
confMatrixLogFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsaraharm_4000/exp/" + modelFolder + '_' + baseName + '_confMatrix.log', 'a+')
deepModel = DeepLabModel(pb_path)

if isDebug:
  val = np.array(['2940226', 'img (31)'])
else:
  val = np.loadtxt('/home/conteinerFiles/skin-images/' + baseName + ".txt", dtype=str)
...
for idx in val:
  ...
  seg_map_save = seg_map.astype(np.uint8)
  seg_map = np.resize(seg_map, labelArray.shape)
  
  # save image label
  
  seg_map_save = seg_map_save != 0
  seg_map_save = seg_map_save * 255
  plt.imsave("/home/conteinerFiles/FinalResults/Tests/" + modelFolder + "_GTEA"+ "_speedTest" + hsaraharm + "/" + idx, seg_map_save)
