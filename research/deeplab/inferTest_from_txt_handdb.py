...
if runAcc:
  confMatrixLogFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsaraharm_4000/exp/" + modelFolder + '_speedTest.log', 'a+')
...
for idx in myFiles:
  ...
  seg_map = seg_map != 0
  seg_map = seg_map * 255
  plt.imsave("/home/conteinerFiles/FinalResults/Tests/" + modelFolder + "_speedTest" + outputsizeFolderName + hsaraharm + "/" + idx, seg_map)
