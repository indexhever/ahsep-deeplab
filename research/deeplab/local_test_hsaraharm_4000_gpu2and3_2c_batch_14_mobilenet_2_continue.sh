...
#sh download_and_convert_hsaraharm_4000.sh
...
EXP_FOLDER="exp/train_on_trainval_set_30000_batchnorm_correctlabel_eval_test_train_2classes_14batch_mobilenet_2"
...
python "${WORK_DIR}"/train.py \
  ...
  --tf_initial_checkpoint="/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsaraharm_4000/exp/train_on_trainval_set_30000_batchnorm_correctlabel_eval_test_train_2classes_14batch_mobilenet_2/train/model.ckpt-13028" \
  --train_logdir="${TRAIN_LOGDIR}" \
  --dataset_dir="${HSARAH_DATASET}" \
  --dataset="hsaraharm_4000" \
