...
if runAcc:
  logFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsarah/exp/" + modelFolder + '_' + baseName + '_acc.log', 'a+')
confMatrixLogFile = open("/home/conteinerFiles/deeplab/models/research/deeplab/datasets/hsarah/exp/" + modelFolder + '_' + baseName + '_confMatrix.log', 'a+')
deepModel = DeepLabModel(pb_path)

if isDebug:
  val = np.array(['2940226', 'img (31)'])
else:
  val = np.loadtxt('/home/conteinerFiles/skin-images/list_folder/' + baseName + ".txt", dtype=str)
...
for idx in val:
  ...
  if len(result2) >= 2:
    labelImagePath = '/home/conteinerFiles/skin-images/masks/{}.jpg'.format(idx)
  else:
    labelImagePath = '/home/conteinerFiles/skin-images/masks/{}.pbm'.format(idx)
  # preprocess images
  ...
  if len(result2) >= 2:
    labelArray = np.resize(labelArray, (seg_map.shape[0], seg_map.shape[1], 3))
    labelArray = np.sum(labelArray, axis=2)
